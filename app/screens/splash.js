...
export default class Splash extends React.Component  {
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{position:'relative',fontSize:30,marginTop:'20%', textAlign:'center', color:'#364f6b', fontFamily:'FuturaH'}}>GreenWalk</Text>
     
      
      <Text style={{position:'relative',fontSize:20,margin:'auto', textAlign:'center', color:'#FFF', fontFamily:'FuturaH', marginTop:'25%', backgroundColor:'#20BF55', padding:'5%', width:'70%', borderRadius:10, alignSelf:'center', elevation:1}} onPress={()=>this.props.navigation.navigate('Login')}>LOGIN</Text>
