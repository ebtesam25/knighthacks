...
export default class Reg extends React.Component  {
  ...
  registerUser(){
    fetch('https://us-central1-aiot-fit-xlab.cloudfunctions.net/reg', {
        method: 'POST',
        headers: {
...
console.log(responseJson);
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <TextInput placeholder='Email' style={{position:'relative',fontSize:20,margin:'auto', paddingLeft:'5%', color:'#798497', fontFamily:'FuturaL', marginTop:'35%', backgroundColor:'#EAEAEA',padding:'2.5%', width:'80%', borderRadius:5,alignSelf:'center'}}></TextInput>
      ...
      <Text style={{position:'relative',fontSize:20,margin:'auto', textAlign:'center', color:'#FFF', fontFamily:'FuturaH', marginTop:'15%', backgroundColor:'#20BF55', padding:'5%', width:'70%', borderRadius:10, alignSelf:'center', elevation:1}} onPress={()=>{this.registerUser();this.props.navigation.navigate('Login');}}>REGISTER</Text>
